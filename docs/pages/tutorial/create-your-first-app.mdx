...
_In this chapter, learn how to create a new Expo project._
...
What does the <CODE>reset-project</CODE> script do?</>}>
...
[App running on all platforms](https://docs.expo.dev/static/images/tutorial/01-app-running-on-all-platforms.png)
...
[App with updated text and background color](https://docs.expo.dev/static/images/tutorial/02-index-screen-changes.png)
